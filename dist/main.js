...
function ProdutoComponent(props) {
    ...
    }, props.item.nome), React.createElement("small", null, "R$", props.item.preco), React.createElement("p", {
        className: "card-text"
    }, props.item.descricao), React.createElement("button", {
...
function CarrinhoComponent(props) {
    return React.createElement("div", {
        ...
        return React.createElement("div", {
            ...
            className: "card=title"
        }, props.itens[produtoId].nome), React.createElement("p", {
            className: "card-text"
        }, "Pre\xE7o unidade: R$", props.itens[produtoId].preco, " | Quantidade: ", props.itens[produtoId].quantidade), React.createElement("p", {
            className: "card-text"
        }, "Valor: R$", props.itens[produtoId].preco * props.itens[produtoId].quantidade), React.createElement("button", {
...
function AppComponente() {
    ...
    return React.createElement(React.Fragment, null, React.createElement("div", {
        className: "col-sm-8"
    }, React.createElement(ListaProdutosComponent, null, produtosLista.map((produto, index) => React.createElement(ProdutoComponent, {
        item: produto,
